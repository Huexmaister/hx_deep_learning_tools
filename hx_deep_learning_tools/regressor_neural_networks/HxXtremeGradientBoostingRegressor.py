from hx_deep_learning_tools.aux_resources.hx_model_evaluation_and_metrics.regressors import EvaluateRegressor, RegressorMetricsCalculations
...
class HxXtremeGradientBoostingRegressor(HxDeepLearningBaseModel):
